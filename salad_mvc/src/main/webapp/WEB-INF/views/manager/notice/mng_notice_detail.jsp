...
안녕하세요. 샐러드입니다.</br>
닭가슴살 슬라이스 3종(갈비맛 / 양념치킨맛 / 커리맛) 상품이 리뉴얼되어 출시되었습니다.</br>
이전 제품 대비 나트륨은 줄이고, 더 두텁고 톡톡하고 부드러운 식감의 닭가슴살 슬라이스를 만나보실 수 있습니다.</br>
단백질 보충 및 든든한 식단 관리에 도움이 될 식단템이 되었으면 좋겠어요. </br>
오늘도 건강하고 맛있는 한끼 되세요.</br>
샐러드
								</text>
							</td>
						</tr>
             ...
             <div style="display: flex; justify-content: space-between;  width: 90%; margin-left: 85px; margin-bottom: 20px;">
				<div>
					<input type="button" value="이전 글" class="button">
					<input type="button" value="다음 글" class="button">
				</div>
