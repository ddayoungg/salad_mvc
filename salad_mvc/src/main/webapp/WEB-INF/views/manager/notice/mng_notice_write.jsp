				...
				<div class="card-body">
					...
					<tbody>
						...
						<tr style="border-top: 1px solid; height: 60px;">
							<th>제목</th>
							<td>
								<input type="text" placeholder="제목을입력해주세요" style="border: 1px solid #ddd; width: 100%; height: 40px;">
							</td>
						</tr>
						<tr style="border-top: 1px solid; height: 60px;">
							<th>작성자</th>
						...
						<tr style="border-top: 1px solid; border-bottom: 1px solid; height: 300px;">
							<th>내용</th>
							<td>
								<textarea placeholder= "내용을 입력해주세요" style="border: 1px solid #ddd; width: 100%; height: 200px;" ></textarea>
							</td>
						</tr>
					</tbody>
				</table>    
