				...
				<div class="card-body">
					...
					<tbody>
						...
						<tr style="border-top: 1px solid;height: 60px;">
							<th>제목</th>
							<td>
								<input type="text" value="닭가슴살 슬라이스 3종 리뉴얼 출시" style="border: 1px solid #ddd; width: 100%; height: 40px;">
							</td>
						</tr>
						<tr style="border-top: 1px solid; height: 60px;">
							<th>작성자</th>
						...
						<tr style="border-top: 1px solid; border-bottom: 1px solid; height: 300px;">
							<th>내용</th>
							<td>
								<textarea style="border: 1px solid #ddd; width: 100%; height: 200px;">
안녕하세요. 샐러드입니다.
닭가슴살 슬라이스 3종(갈비맛 / 양념치킨맛 / 커리맛) 상품이 리뉴얼되어 출시되었습니다.
이전 제품 대비 나트륨은 줄이고, 더 두텁고 톡톡하고 부드러운 식감의 닭가슴살 슬라이스를 만나보실 수 있습니다.
단백질 보충 및 든든한 식단 관리에 도움이 될 식단템이 되었으면 좋겠어요. 
오늘도 건강하고 맛있는 한끼 되세요.
샐러드
								</textarea>
							</td>
                	...
                	<div style="display: flex ;justify-content: end; margin-bottom: 100px; margin: 0px 0px 50px 0px; width: 95%">
