                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row" style="margin:0 50px 0 50px;">
                            <div style="font-size:20px; font-weight:bold; padding:0 0 10px 0;">주문서 상세 정보</div>
                            <table >
                            	<thead>
                            		<tr align="center" height="30px" style="border-top:1px solid #777777;
                            		border-bottom:1px solid #777777; font-size:16px; font-weight:bold;">
                            			<th>날짜/주문번호</th>
                            			<th>상품명</th>
                            			<th>수량</th>
                            			<th>상품 금액</th>
                            	...
                            	<tbody align="center">
                            		<tr height="150px" style="border-bottom:1px solid #777777;">
                            			<td style="font-size:16px;" rowspan="3">2022/10/26<br>
                            			<div style="text-decoration:underline; 
                            			padding:15px 0 0 0; color:rgb(26,188,165);">
                            			2010261642000097</div><br>
                            			<span style="color:rgb(22,160,133); font-weight:bold;">취소 확정</span>
                            			</td>
                            			<td style="font-size:16px;"><img alt="img" src="./resources/mng_images/sasalad.jpg" width="120px">
                            			[새벽배송]채소만 샐러드</td>
                            			<td style="font-size:16px;">1개</td>
                            			<td style="font-size:20px; color:rgb(192,57,43); font-weight:bold;">3,400원</td>
                            		</tr>
                            		<tr height="150px" style="border-bottom:1px solid #777777;">
                            			<td style="font-size:16px;"><img alt="img" src="./resources/mng_images/sasalad.jpg" width="120px">
                            			[새벽배송]채소만 샐러드</td>
                            ...
                            <table >
                            		<tr align="center" height="80px">
                            			<td rowspan="2"></td>
                            			<td width="300px" valign="bottom" style="font-size:16px;  font-weight:bold;">총 상품금액</td>
                            			<td rowspan="2" width="50px"><img alt="img" src="./resources/mng_images/arrow-green.png" height="25px"></td>
                            			<td width="300px" valign="bottom" style="font-size:16px;  font-weight:bold;">총 할인금액</td>
                            			<td rowspan="2" width="50px"><img alt="img" src="./resources/mng_images/arrow-gray.png" height="25px"></td>
                            			<td width="300px" valign="bottom" style="font-size:16px;  font-weight:bold;">배송비</td>
                            			<td rowspan="2" width="50px"><img alt="img" src="./resources/mng_images/arrow-gray.png" height="25px"></td>
                            			<td width="300px" valign="bottom"  style="font-size:16px;  font-weight:bold;">합계</td>
                            			<td rowspan="2"></td>
                            		</tr>
                            		<tr align="center" valign="top" height="80px" style="border-bottom:1px solid #777777;">
                            			<td style="font-size:24px;  font-weight:bold;">15,600원</td>
                            			<td style="font-size:24px;  font-weight:bold;">5,100원</td>
                            			<td style="font-size:24px;  font-weight:bold;">3,000원</td>
                            			<td style="font-size:24px;  font-weight:bold;">13,500원</td>
                            		</tr>                      
                             </table>
                             <!-- 주문 상태가 취소 확정 시 이 테이블이 나타나야함   -->
                             <table>
                             	<tr align="center" valign="bottom" height="80px">
                            			<td style="font-size:16px;  font-weight:bold;">환불 금액</td>
                            		</tr>
                            		<tr align="center" valign="top" height="80px" style="border-bottom:1px solid #777777;">
                            			<td style="font-size:24px;  font-weight:bold;">13,500원</td>
                            		</tr>
                             ...
                             <!-- 주문자 정보  -->
                             <div style="font-size:20px; font-weight:bold; padding:40px 0 10px 0;">주문자 정보</div>
                             <table>
                             	<tr></tr>
                             	<tr align="left"height="50px" style="border-top:1px solid #777777;">
                             	...
                             	<tr align="left" height="50px" style="border-bottom:1px solid #777777;">
                             		<td>이메일</td>
                             		<td>dohee123@naver.com</td>
                             	</tr>
                             	<tr></tr>
                             </table>
                             <!-- 배송 정보  -->
                             <div style="font-size:20px; font-weight:bold; padding:40px 0 10px 0;">배송 정보</div>
                             <table>
                             	<tr></tr>
                             	<tr align="left" height="50px" style="border-top:1px solid #777777;">
                             	...
                             	<tr align="left">
                             		...
                             		<td height="35px" style="vertical-align: top;">(06221)</td>
                             	</tr>
                             	<tr>
                             		<td height="35px" style="vertical-align: top;">아파트 서울특별시 강남구 언주로 85길 32</td>
                             	</tr>
                             	<tr align="left">
                             		<td rowspan="2" height="70px" style="vertical-align: top;">받으실 분</td>
                             		<td height="35px" style="vertical-align: top;">김도희</td>
                             	</tr>
                             	<tr>
                             		<td height="35px" style="vertical-align: top;">010-0000-0000</td>
                             	</tr>
                             	<tr align="left" height="50px" style="border-bottom:1px solid #777777;">
                             		<td>배송 요청사항</td>
                             		<td>신선한 제품으로 주세요</td>
                    	...
                    	<button style="background-color:rgb(22,160,133); color:white; border:none; height:40px; width:70px; font-weight:bold;" 
                    	type="button" onclick="location.href='mng_order.do'">확인</button>
                    	</div>
                </main>
               	<!-- 푸터 -->
