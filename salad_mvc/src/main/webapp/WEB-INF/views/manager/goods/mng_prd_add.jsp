...
$(function(){
	...
	$("#saveBtn").click(function() {//등록 버튼 누를 시
		nullChk();
	});
...
function gd_add_upload(imgType){
	...
	if(imgType == "") {
		...
		output ="<div name='fileUploadSec' style='margin-top: 15px;'>";
		...
		output ="<div name='fileBodyUploadSec' style='margin-top: 15px;'>";
	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			<main>
				...
				<form name="saveFrm" id="saveFrm" action="add_save_prd_process.do" method="post" enctype="multipart/form-data">
				<div class="dataTable-wrapper dataTable-loading no-footer searchable fixed-columns">
					<div class="dataTable-container">
						<table class="dataTable-table" style="width: 80%; margin: 20px auto;">
							<tbody>
								<tr>
									<th>상품명</th>
									<td><input type="text" id="prdName" name="prdName" placeholder="상품명을 입력해주세요."></td>
								</tr>
								<tr>
									<th>메인 사진</th>
									<td id="uploadBox">
										<span><strong>메인이미지</strong></span>
										<div style="margin-top: 15px;">
											<img id="imgOutput0" class="imgBig" src="">
											<input type="file" id="upFile0" name="upFile0" onchange="setFile(0, '')" class="file" title="찾아보기"/>
											<input type="hidden" class="file_text" title="파일 첨부하기" readonly="readonly" id="prdImg0" name="thum"/>
										</div>
				...
				<div class="dataTable-wrapper dataTable-loading no-footer searchable fixed-columns" style="width: 82%; margin: 0px auto;">
					...
					<div align="center" style="margin: 20px 0px;">
						...
						<input type="button" id="saveBtn" class="button" value="등록">
					</div>
				</div>
