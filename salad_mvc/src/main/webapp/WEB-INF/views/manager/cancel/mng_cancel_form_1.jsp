...
<html lang="en">
	...
	<div id="mngCancelForm1" class="popup" align="center">
	 <div class="content">
		<div style="width: 450px; border: 1px solid grey;">
			<div style="font-weight: bold; font-size: 20px; border-bottom: 2px solid #ddd; padding: 15px;" align="left">취소 현황 변경</div>
				...
				<div style="display: flex; align-items: center; justify-content: center; padding-bottom: 10px;">
					<input type="button" value="취소" class="button" onclick="location.href='mng_cancel.do'">	
					<input type="button" value="확인" class="button" onclick="location.href='mng_cancel_form_2.do'">
				</div>
			</div>
		</div>
	  </div>
