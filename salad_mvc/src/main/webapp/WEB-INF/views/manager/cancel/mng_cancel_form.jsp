		...
		<div class="content">
			<div style="width: 800px; border: 1px solid grey;">
				...
				<div style="width: 800px;">
					...
					<table id="detailPopup" class="member" style="width: 95%;">
						<tbody align="center">
							...
							<tr height="40px">
								<td style="border: 1px solid #f0f0f0;">202210260025</td>
								<td style="border: 1px solid #f0f0f0;">김도희</td>
								<td style="border: 1px solid #f0f0f0;">2022-10-26</td>
								<td style="border: 1px solid #f0f0f0;">3,800원</td>
							</tr>
						</tbody>
					</table>
				</div>	
				...
				<div style="display: flex; align-items: center; justify-content: center; margin-top: 10px;">
					<input type="button" value="닫기" class="button" onclick="location.href='mng_cancel.do'">
