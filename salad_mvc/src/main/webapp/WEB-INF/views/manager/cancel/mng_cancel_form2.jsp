                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" style="padding-top:0; padding-bottom:28px" href="mng_notice.do">
                                -배송 관리
                            </a>
                            <hr style="width:90%; text-align:center; margin:auto;">
			...
			<div style="width: 450px; border: 1px solid grey;">
				<div style="font-weight: bold; font-size: 20px; border-bottom: 2px solid #ddd; padding: 15px;" align="left">취소 현황 변경</div>
					...
					<div style="display: flex; align-items: center; justify-content: center; padding-bottom: 10px;">
						...
						<input type="button" value="확인" class="button" onclick="showPopup(true,'mngCancelForm2')">
					</div>
				</div>
			</div>
		  </div>	  
		  <!-- 끝 -->
		<!-- 팝업창 : mng_cancel_form_2/ 취소 현황 변경 완료-->
	        <div id="mngCancelForm2" class="popup" align="center">
		 <div class="content">
			<div style="width: 450px; border: 1px solid grey;">
				<div style="font-weight: bold; font-size: 20px; border-bottom: 2px solid #ddd; padding: 15px;" align="left">취소 현황 변경 완료</div>
					...
					<div style="display: flex; align-items: center; justify-content: center; padding-bottom: 10px;">
						<input type="button" value="확인" class="button" onclick="location.href='mng_cancel.do'">
					</div>
				</div>
			</div>
		  </div>
