...
<!-- 본문 리스트 시작 -->
                 <div class="card-body">
					...
					<tbody >
						...
						<tr style="border-top: 1px solid; height: 300px;">
							<th>내용</th>
							<td>
								<img  style="width:300px; height:100px; " src="./resources/mng_images/qna_detail.PNG"></br>
								<text style="border: 0px; width: 100%; height: 200px;">
									문의드립니다. </br>
									샐러드 원산지가 궁금합니다. </br>
								</text>
							</td>
						...
						<tr style="border-top: 1px solid; background-color: #ECECEC; height: 60px;">
							<th>A.</th>
							<td>
								<input type="text" value="안녕하세요. 건강한 식단 샐러드입니다."  style="border: 0px; width: 100%; height: 40px;">
							</td>
						</tr>
						<tr style="border-top: 1px solid;  background-color: #ECECEC; height: 60px;">
							<th>작성자</th>
						...
						<tr style="border-top: 1px solid;  border-bottom: 1px solid;  background-color: #ECECEC; height: 300px;">
							<th>답변 내용</th>
							<td>
								<textarea style="border: 0px; width: 100%; height: 200px;">
고객님 저희 샐러드는 채소, 닭가슴살 모두 국내산을 이용하여 제작하고 있습니다. ^^
감사합니다.
샐러드
								</textarea>
							</td>
            ...
            <div style="display: flex ;justify-content: end; width: 90%; margin-left: 85px; margin-bottom: 20px;">
				<input type="button" value="답변 등록"  class="button" >
