                 ...
                 <div class="card-body">
					...
					<tbody >
						...
						<tr style="border-top: 1px solid;  background-color: #ECECEC; height: 60px;">
							<th>작성자</th>
							<td>
								<text  readonly=“readonly”  style="border: 0px; width: 100%; height: 40px;">
								관리자 2022-10-27
							</td>
						</tr>
						<tr style="border-top: 1px solid;  border-bottom: 1px solid;  background-color:#ECECEC; height: 300px;">
							...
							<td>
								<text style="border: 0px; width: 100%; height: 200px;">
								고객님 저희 샐러드는 채소, 닭가슴살 모두 국내산을 이용하여 제작하고 있습니다. ^^</br>
								감사합니다.</br>
								샐러드
								</text>
							</td>
                    ...
                    <div class="container-fluid px-4">
                        <div class="align-items-center justify-content-between small">
                            ...
                            <div style="display: flex; justify-content: space-between;" >
	                        	...
	                        	<div>
	                        		<img alt="img" src="i./resources/mng_images/saladLogo.png">
	                        	</div>
                        	</div>
                        </div>
                    </div>
