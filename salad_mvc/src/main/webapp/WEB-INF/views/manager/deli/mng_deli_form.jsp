...
<html lang="en">
	...
	<div id="popupDeliForm" class="popup">
		<div class="content">
			<div style="width: 800px; border: 1px solid grey;">
				<div style="font-weight: bold; font-size: 20px; border-bottom: 2px solid #ddd; padding: 15px;" align="left">배송 현황
				</div>

				<div style="width: 800px; display: flex; flex-direction:column; justify-content: center; align-items: center;">
					<!-- 배송 상태에 따라 해당 이미지 출력  -->
					<!-- <img alt="img" src="./resources/mng_images/delivery-man.png" style="width:150px;"> --> <!-- 배송 준비 중 이미지  -->
					<img alt="img" src="./resources/mng_images/shipped.png" style="width:150px;"><!-- 배송 중 이미지  -->
					<!-- <img alt="img" src="./resources/mng_images/delivery.png" style="width:150px;"> --> <!-- 배송 완료 이미지  -->
					
					<div style="font-size:18px;">현재 김도희님의 배송 현황은 <span style="color:rgb(22,160,133);">[ 배송 중 ]</span> 입니다.</div>
					<div style=" margin:30px 0 30px 0; font-size:18px;">
						<button class="deliFormBtn" type="button" onclick="location.href='mng_deli_form_1.do'">배송 준비 중</button>
						<button class="deliFormBtn" type="button" onclick="location.href='mng_deli_form_2.do'">배송 중</button>
						<button class="deliFormBtn" style="margin:0;" type="button" onclick="location.href='mng_deli_form_3.do'">배송 완료</button>
					</div>
				</div>
			</div>
			<div style="width: 800px; display: flex; align-items: center; justify-content: center; margin-top: 10px;">
				<input type="button" value="닫기" class="button" onclick="location.href='mng_deli.do'">	
			</div>
		</div>
	</div>
