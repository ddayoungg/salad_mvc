...
<html lang="en">
    ...
    <!-- 내용 끝 -->
    <!-- 팝업창 : mng_deli_form_4 / 배송 현황 변경됨-->
	<div id="mngDeliForm4" class="popup" align="center">
	 <div class="content">
		<div style="width: 450px; border: 1px solid grey;">
			<div style="font-weight: bold; font-size: 20px; border-bottom: 2px solid #ddd; padding: 15px;" align="left">배송 현황 완료</div>
			
				<div style="font-size: 16px; display: flex; justify-content: center; align-items: center; height: 70px ;">변경되었습니다.</div>
				
				<div style="display: flex; align-items: center; justify-content: center; padding-bottom: 10px;">
					<input type="button" value="확인" class="button" onclick="location.href='mng_deli.do'">
				</div>
			</div>
		</div>
	  </div>
