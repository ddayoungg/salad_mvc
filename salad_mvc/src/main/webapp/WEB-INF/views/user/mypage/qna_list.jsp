...
function gdqna_open_detail_popup(prdNum, qnaNum){//상품 후기 상세보기
	...
	window.open("http://localhost/salad_mvc/qna_detail.do?prdNum="+prdNum+"&qnaNum="+qnaNum, "상품문의 상세보기", "width=800, height=750, left="+leftVal+", top="+topVal+"");
}//gd_open_write_popup
...
function setQnaList(currentPage){
	$.ajax({
		url:"http://localhost/salad_mvc/my_qna_list_ajax.do",
		...
		success:function(jsonObj){
			...
			if(!jsonObj.isEmpty){
				$.each(jsonObj.list, function(i, json){
					...
					tbOutput+="<td><a href='#void' onclick='gdqna_open_detail_popup("+json.prdNum+", "+json.qnaNum+")'>"+qnaTitle+"</a></td>";
...
<!-- //mypage_top_info -->
        ...
        <div class="mypage_wish_list">
            ...
            <div class="mypage_table_type" id="qnaListOutput">
                
            </div>
			<div id="qnaPageOutput" style="text-align: center">
