...
function gdqna_open_detail_popup(prdNum, qnaNum){//상품 후기 상세보기
	...
	window.open("http://salad.sist.co.kr/qna_detail.do?prdNum="+prdNum+"&qnaNum="+qnaNum, "상품문의 상세보기", "width=800, height=750, left="+leftVal+", top="+topVal+"");
}//gd_open_write_popup
...
function setQnaList(currentPage){
	$.ajax({
		url:"http://salad.sist.co.kr/my_qna_list_ajax.do",
