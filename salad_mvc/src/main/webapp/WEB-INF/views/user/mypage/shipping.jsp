...
<head>
    ...
    <meta name="csrf-token" content="MTY2NjcwODM3MTIzMjM2NDk0MzkyMTI0NzMyMzIyNDQwMzExOTQyNDg3" />
   <meta name="facebook-domain-verification" content="l8vlpgoyq5exc97dfww64gqzmnialy" />
    ...
    <meta property="og:url" content="https://pocketsalad.co.kr/mypage/shipping.jsp">
...
<script type="text/javascript">
    ...
    <!-- Add script : start -->
    <script type="text/javascript" src="/admin/gd_share/script/visit/gd_visit.js?requestUrl=https%3A%2F%2Fcollector-statistics.nhn-commerce.com%2Fhttp.msg&requestData=%7B%22base_time%22%3A%222022-10-25T23%3A32%3A51%2B09%3A00%22%2C%22mall_id%22%3A%22652040%22%2C%22user_id%22%3A%2285762%22%2C%22refer%22%3A%22https%3A%5C%2F%5C%2Fpocketsalad.co.kr%3A443%22%2C%22uri%22%3A%22shipping.jsp%22%2C%22domain%22%3A%22pocketsalad.co.kr%22%2C%22country%22%3A%22kr%22%2C%22solution%22%3A%22G5%22%7D&dummyData=?v=2020120404"></script>
    <!-- Add script : end -->
...
<script type="text/javascript" src="http://localhost/salad_mvc/resources/js/naver/naverCommonInflowScript.js?Path=/mypage/shipping.jsp&amp;Referer=https://pocketsalad.co.kr:443&amp;AccountID=s_2dc21239d6a&amp;Inflow=pocketsalad.co.kr" id="naver-common-inflow-script"></script>
...
<body id="body" class="body-mypage body-shipping pc"  >
...
<script type="text/javascript">
function deliPopup(){
	window.open('delipopup.do','배송지 관리','top=100px, left=400px, width=1000px, height=800px, ');
}
</script>
        <!-- 마이페이지 회원 요약정보 -->
        ...
        <div class="mypage_shipping js_delivery_layer">
            <div class="mypage_zone_tit">
                <h3>배송지 관리</h3>
				<span class="pick_list_num">배송지 관리 내역 총 <strong>1</strong>건</span>
            </div>
            ...
            <div class="mypage_shipping_cont">
                <div class="mypage_table_type">
                    ...
                    <table>
                        ...
                        <tbody>
                        <c:if test="${empty mdDomain }">
                        	<tr>
                            <td colspan="5"><p class="no_data">배송지 목록이 없습니다.</p></td>
                        	</tr>
                        </c:if>
                        <c:if test="${not empty mdDomain }">
                        <tr>
                            <td><span>(기본배송지)</span><strong>${mdDomain.name}</strong></td>
                            <td>${mdDomain.name}</td>
                            <td class="td_left">
                                <span>(${mdDomain.zipcode})</span> ${mdDomain.addr} &nbsp; ${mdDomain.deAddr}
                            </td>
                            <td class="td_phone"><span>휴대폰 : ${mdDomain.phone}</span></td>
                            <td>
                                <span class="btn_gray_list"><a href="" class="btn_gray_small btn_open_layer" data-sno="34157" onclick="deliPopup()"><span>수정</span></a></span>
                            </td>
                        </tr>
                        </c:if>
                        </tbody>
