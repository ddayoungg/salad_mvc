    ...
    $(function(){
        ...
        $('.btn_add_shipping.btn_open_layer, .js_delivery_layer .btn_open_layer').bind('click', function(e){
            ...
            if (target == '#lyDeliveryAdd') {
                ...
                // AJAX 호출
                $(target).empty();
                $.get('../order/layer_shipping_address_regist.jsp' + param, function(data){
                    $(target).append(data);
        ...
        $('.js_delete').click(function(e){
            if ($(this).data('default-fl') == 'y') {
                ...
                if (confirm("나의 배송지 [" + $(this).closest('tr').data('shipping-name') + "]을(를) 정말로 삭제하시겠습니까?")) {
                    ...
                    $.post('../order/layer_shipping_ps.jsp', params, function(data){
                        if(data.code == 200) {
...
//        $.get('../order/layer_shipping_address.jsp?' + page, function(data){
