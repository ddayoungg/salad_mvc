			...
			<tr data-order-no="2210251644000099" data-order-goodsno="442263" data-order-status="r3" data-order-userhandlesno="8969">
		        ...
		        <div class="pick_add_cont">
		            <span class="pick_add_img">
						<a href="http://localhost/salad_mvc/goods/goods_view.do?prdNum=${ order.prdNum }"><img src="http://localhost/salad_mvc/common/images/product/${ order.thum }" width="50" class="middle"  /></a>
		            </span>
		            <div class="pick_add_info">
						<a href="http://localhost/salad_mvc/goods/goods_view.do?prdNum=${ order.prdNum }"><em><c:out value="${ order.prdName }"/></em></a>
		            </div>
		        </div>
		        <!-- //pick_add_info -->
		    	</td>
