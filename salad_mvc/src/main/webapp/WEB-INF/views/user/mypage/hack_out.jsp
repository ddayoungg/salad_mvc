...
<head>
    ...
    <meta name="csrf-token" content="MTY2NjcwODQ1NDY5OTU3MzUxOTIyNzMzNzQ0NDc0MTk5MjIxNjE5MzU1" />
   <meta name="facebook-domain-verification" content="l8vlpgoyq5exc97dfww64gqzmnialy" />
    ...
    <meta property="og:url" content="https://pocketsalad.co.kr/mypage/hack_out.jsp">
    ...
    <!-- Add script : start -->
    <script type="text/javascript" src="/admin/gd_share/script/visit/gd_visit.js?requestUrl=https%3A%2F%2Fcollector-statistics.nhn-commerce.com%2Fhttp.msg&requestData=%7B%22base_time%22%3A%222022-10-25T23%3A34%3A14%2B09%3A00%22%2C%22mall_id%22%3A%22652040%22%2C%22user_id%22%3A%2285762%22%2C%22refer%22%3A%22https%3A%5C%2F%5C%2Fpocketsalad.co.kr%3A443%22%2C%22uri%22%3A%22hack_out.jsp%22%2C%22domain%22%3A%22pocketsalad.co.kr%22%2C%22country%22%3A%22kr%22%2C%22solution%22%3A%22G5%22%7D&dummyData=?v=2020120404"></script>
    <!-- Add script : end -->
...
<script type="text/javascript" src="http://localhost/salad_mvc/resources/js/naver/naverCommonInflowScript.js?Path=/mypage/hack_out.jsp&amp;Referer=https://pocketsalad.co.kr:443&amp;AccountID=s_2dc21239d6a&amp;Inflow=pocketsalad.co.kr" id="naver-common-inflow-script"></script>
...
<body id="body" class="body-mypage body-hack-out pc"  >
        ...
        <fieldset>
            ...
            <div class="top_search_cont">
                <div class="top_text_cont">
                    ...
                    <input type="image" src="http://localhost/pocket/img/main/sch_btn.png" id="btnSearchTop" class="btn_top_srarch" title="검색" value="검색" alt="검색">
                </div>
                <!-- //top_text_cont -->
    ...
    <ul class="sub_menu_mypage">
        <li>쇼핑정보
            <ul class="sub_depth1">
                ...
                <li><a href="mypage/cancel_list.do">- 취소내역</a></li>
...
<div class="content">
    <div class="mypage_cont">
        <form id="formHackOut" name="formHackOut" action="mypage_out_process.do" method="post">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form_element">
                                        ...
                                        <li><input type="radio"  id="reasonCd01003001" name="outReason" class="checkbox" value="제품 불만족">
                                        <label for="reasonCd01003001" class="check-s">제품 불만족</label></li>
                                        <li><input type="radio"  id="reasonCd01003002" name="outReason" class="checkbox" value="고객서비스(상담,포장 등) 불만족">
                                        <label for="reasonCd01003002" class="check-s">고객서비스(상담,포장 등) 불만족</label></li>
                                        <li><input type="radio"  id="reasonCd01003003" name="outReason" class="checkbox" value="배송불만">
                                        <label for="reasonCd01003003" class="check-s">배송불만</label></li>
                                        <li><input type="radio" id="reasonCd01003004" name="outReason" class="checkbox" value="교환/환불/반품 불만">
                                        <label for="reasonCd01003004" class="check-s">교환/환불/반품 불만</label></li>
                                        <li><input type="radio" id="reasonCd01003005" name="outReason" class="checkbox" value="방문 빈도가 낮음">
                                        <label for="reasonCd01003005" class="check-s">방문 빈도가 낮음</label></li>
                                        <li><input type="radio" id="reasonCd01003006" name="outReason" class="checkbox" value="상품가격 불만">
                                        <label for="reasonCd01003006" class="check-s">상품가격 불만</label></li>
                                        <li><input type="radio"  id="reasonCd01003007" name="outReason" class="checkbox" value="쇼핑몰의 신뢰도 불만">
                                        <label for="reasonCd01003007" class="check-s">쇼핑몰의 신뢰도 불만</label></li>                         
                                    </div>
                                </td>
                            </tr>
                            </tbody>
    ...
    $(document).ready(function () {
        $('#formHackOut').validate({
            rules: {
            	...
            	pass: "비밀번호를 입력해주세요",
            	outReason: "탈퇴사유를 1개 이상 체크하여 주시기바랍니다."
            },
            submitHandler: function (form) {
                var params = $(form).serializeArray();
                var mileage = "0원";
                if (confirm("정말로 탈퇴하시겠습니까?")) {
                    form.action = 'mypage_out_process.do';
                    form.submit();
                }
            }
        });
