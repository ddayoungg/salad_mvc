...
<head>
    ...
    <meta name="csrf-token" content="MTY2NjY4Nzc3MDY0MjA3NTgxMzk2MDc2OTM5NDI1MTI0NzA3MDc5Njg5" />
   <meta name="facebook-domain-verification" content="l8vlpgoyq5exc97dfww64gqzmnialy" />
    ...
    <meta property="og:url" content="https://www.pocketsalad.co.kr/member/user_certification.jsp">
...
<script type="text/javascript">
    ...
    <!-- Add script : start -->
    <script type="text/javascript" src="/admin/gd_share/script/visit/gd_visit.js?requestUrl=https%3A%2F%2Fcollector-statistics.nhn-commerce.com%2Fhttp.msg&requestData=%7B%22base_time%22%3A%222022-10-25T17%3A49%3A30%2B09%3A00%22%2C%22mall_id%22%3A%22652040%22%2C%22user_id%22%3Anull%2C%22refer%22%3A%22https%3A%5C%2F%5C%2Fwww.pocketsalad.co.kr%3A443%22%2C%22uri%22%3A%22user_certification.jsp%22%2C%22domain%22%3A%22www.pocketsalad.co.kr%22%2C%22country%22%3A%22kr%22%2C%22solution%22%3A%22G5%22%7D&dummyData=?v=2020120404"></script>
    <!-- Add script : end -->
...
<script type="text/javascript" src="http://localhost/salad_mvc/resources/js/naver/naverCommonInflowScript.js?Path=/member/user_certification.jsp&amp;Referer=https://www.pocketsalad.co.kr:443&amp;AccountID=s_2dc21239d6a&amp;Inflow=pocketsalad.co.kr" id="naver-common-inflow-script"></script>
...
<body id="body" class="body-member body-user-certification pc"  >
		...
		<div class="member_cont">
			<div class="user_certify_box">
				<form name="formAuth" id="formAuth" method="post" action="">
					...
					<input type="hidden" name="token" value="MTY2NjY4Nzc3MDY0MjA3NTgxMzk2MDc2OTM5NDI1MTI0NzA3MDc5Njg5"/>
		...
		$('#formAuth').validate({
			...
			messages: {
				...
				switch ($('input[name=authType]:checked').val()) {
					case 'authIpin' :
						var popupWindow = window.open("/member/ipin/ipin_main.jsp?callType=findpwd", "popupCertKey", "top=100, left=200, status=0, width=417, height=490");
						return;
						break;
					case 'authCellphone' :
						var protocol = location.protocol;
						var callbackUrl = "https://www.pocketsalad.co.kr:443/member/authcellphone/dreamsecurity_result.jsp";
						window.open(protocol + "//hpauthdream.godo.co.kr/module/Mobile_hpauthDream_Main.jsp?callType=findid&shopUrl=" + callbackUrl + "&cpid=", "auth_popup", "top=30, left=50, status=0, width=425, height=650");
						break;
					case 'authEmail':
					case 'authSms':
						$.post('../member/user_certification_ps.jsp', params).done(function (data, textStatus, jqXHR) {
							...
							if (_.isUndefined(code) && _.isUndefined(message)) {
								alert(data);
								form.action = '../member/user_certification_confirm.jsp';
								form.submit();
							} else {
