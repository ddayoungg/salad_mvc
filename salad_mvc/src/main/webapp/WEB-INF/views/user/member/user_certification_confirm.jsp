...
<head>
    ...
    <meta name="csrf-token" content="MTY2NjY4NzkyNTM5MTMxMTkwMTM2MzU4OTcwNjc3MTQ4MzM1MDA1OTkw" />
   <meta name="facebook-domain-verification" content="l8vlpgoyq5exc97dfww64gqzmnialy" />
    ...
    <meta property="og:url" content="https://www.pocketsalad.co.kr/member/user_certification_confirm.jsp">
    ...
    <!-- Add style : start -->
    <link type="text/css" rel="stylesheet" href="http://localhost/salad_mvc/resources/css/plugins/jquery.countdownTimer.css" />
    <!-- Add style : end -->
...
<script type="text/javascript">
    ...
    <!-- Add script : start -->
    <script type="text/javascript" src="/admin/gd_share/script/visit/gd_visit.js?requestUrl=https%3A%2F%2Fcollector-statistics.nhn-commerce.com%2Fhttp.msg&requestData=%7B%22base_time%22%3A%222022-10-25T17%3A52%3A05%2B09%3A00%22%2C%22mall_id%22%3A%22652040%22%2C%22user_id%22%3Anull%2C%22refer%22%3A%22https%3A%5C%2F%5C%2Fwww.pocketsalad.co.kr%3A443%22%2C%22uri%22%3A%22user_certification_confirm.jsp%22%2C%22domain%22%3A%22www.pocketsalad.co.kr%22%2C%22country%22%3A%22kr%22%2C%22solution%22%3A%22G5%22%7D&dummyData=?v=2020120404"></script>
    <script type="text/javascript" src="http://localhost/salad_mvc/resources/js/jquery/jquery.countdownTimer.js?v=2020120404"></script>
    <!-- Add script : end -->
...
<script type="text/javascript" src="http://localhost/salad_mvc/resources/js/naver/naverCommonInflowScript.js?Path=/member/user_certification_confirm.jsp&amp;Referer=https://www.pocketsalad.co.kr:443&amp;AccountID=s_2dc21239d6a&amp;Inflow=pocketsalad.co.kr" id="naver-common-inflow-script"></script>
...
<body id="body" class="body-member body-user-certification-confirm pc"  >
	...
	<div class="member_wrap">
		...
		<div class="member_cont">
			<form name="formAuthConfirm" id="formAuthConfirm" method="post">
				...
				<input type="hidden" name="token" value="MTY2NjY4NzkyNTM5MTMxMTkwMTM2MzU4OTcwNjc3MTQ4MzM1MDA1OTkw"/>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$('#btnCancel', $formAuthConfirm).click(function (e) {
			e.preventDefault();
			location.href = '../member/user_certification.jsp';
		});
		...
		$('[name=btnAgain]', $formAuthConfirm).click(function (e) {
			...
			$.post('../member/user_certification_ps.jsp', params).done(function (data, textStatus, jqXHR) {
				...
				if (_.isUndefined(code) && _.isUndefined(message)) {
					...
					$('#errorMessage', $formAuthConfirm).removeClass('dn').html('<p class="info_again">' + message + '<a href="#" name="btnAgain">인증번호 다시받기</a></p>');
					if (code == 403) {
			...
			messages: {
				...
				$.post('../member/user_certification_ps.jsp', params).done(function (data, textStatus, jqXHR) {
					...
					if (_.isUndefined(code) && _.isUndefined(message)) {
						...
						switch (certificationType) {
							case 'find_password':
								form.action = '../member/find_password_reset.jsp';
								break;
						}
						form.submit();
					} else {
