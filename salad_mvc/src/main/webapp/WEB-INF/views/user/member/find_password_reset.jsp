...
<head>
    ...
    <meta name="csrf-token" content="MTY2NjY4NzQ2MTY1NDk3OTYxMTQzMjE1MDk3ODY3MTMwOTc4NzIwOTkw" />
   <meta name="facebook-domain-verification" content="l8vlpgoyq5exc97dfww64gqzmnialy" />
    ...
    <meta property="og:url" content="https://www.pocketsalad.co.kr/member/find_password_reset.jsp">
...
<script type="text/javascript">
    $(function(){
    	...
    	//비밀번호 유효성 검사.
    	//비밀번호 일치확인
    	$("#newPass, #newPass_chk").on("propertychange change keyup paste input", function(){
            ...
            if(document.getElementById('newPass').value !="" && document.getElementById('newPass_chk').value!=""){
                if(document.getElementById('newPass').value==document.getElementById('newPass_chk').value){
...
alert("${pwEditFail}");
    ...
    <!-- Add script : start -->
    <script type="text/javascript" src="/admin/gd_share/script/visit/gd_visit.js?requestUrl=https%3A%2F%2Fcollector-statistics.nhn-commerce.com%2Fhttp.msg&requestData=%7B%22base_time%22%3A%222022-10-25T17%3A44%3A21%2B09%3A00%22%2C%22mall_id%22%3A%22652040%22%2C%22user_id%22%3Anull%2C%22refer%22%3A%22https%3A%5C%2F%5C%2Fwww.pocketsalad.co.kr%3A443%22%2C%22uri%22%3A%22find_password_reset.jsp%22%2C%22domain%22%3A%22www.pocketsalad.co.kr%22%2C%22country%22%3A%22kr%22%2C%22solution%22%3A%22G5%22%7D&dummyData=?v=2020120404"></script>
...
<script type="text/javascript" src="http://localhost/salad_mvc/resources/js/naver/naverCommonInflowScript.js?Path=/member/find_password_reset.jsp&amp;Referer=https://www.pocketsalad.co.kr:443&amp;AccountID=s_2dc21239d6a&amp;Inflow=pocketsalad.co.kr" id="naver-common-inflow-script"></script>
...
<body id="body" class="body-member body-find-password-reset pc"  >
...
<div class="content_box">
	<div class="member_wrap">
		...
		<div class="member_cont">
			<form name="formReset"  id="formReset" action="find_pass_process.do" method="post">
					...
					<div class="login_input">
						<div class="js_input_pw">
							<div class="member_warning">
								...
								<input type="password"  id="newPass" name="newPass" autocomplete="off"  placeholder="새 비밀번호">
						...
						<div class="js_input_pw">
							<div class="member_warning">
								<input type="password"  id="newPass_chk" name="newPass_chk"  autocomplete="off" placeholder="새 비밀번호 확인">
