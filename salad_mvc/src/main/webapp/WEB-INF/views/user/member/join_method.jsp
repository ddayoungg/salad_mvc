...
<head>
    ...
    <meta name="csrf-token" content="MTY2NjYyMDI1OTE2ODk3MTMwNjYzMTAwODQ5MjkwMDI4ODcyNDQ0NzA0" />
   <meta name="facebook-domain-verification" content="l8vlpgoyq5exc97dfww64gqzmnialy" />
    ...
    <meta property="og:url" content="https://www.pocketsalad.co.kr/member/join_method.jsp">
...
<script type="text/javascript">
    ...
    <!-- Add script : start -->
    <script type="text/javascript" src="/admin/gd_share/script/visit/gd_visit.js?requestUrl=https%3A%2F%2Fcollector-statistics.nhn-commerce.com%2Fhttp.msg&requestData=%7B%22base_time%22%3A%222022-10-24T23%3A04%3A19%2B09%3A00%22%2C%22mall_id%22%3A%22652040%22%2C%22user_id%22%3Anull%2C%22refer%22%3A%22https%3A%5C%2F%5C%2Fwww.pocketsalad.co.kr%3A443%22%2C%22uri%22%3A%22join_method.jsp%22%2C%22domain%22%3A%22www.pocketsalad.co.kr%22%2C%22country%22%3A%22kr%22%2C%22solution%22%3A%22G5%22%7D&dummyData=?v=2020120404"></script>
...
<script type="text/javascript" src="http://localhost/salad_mvc/resources/js/naver/naverCommonInflowScript.js?Path=/member/join_method.jsp&amp;Referer=https://www.pocketsalad.co.kr:443&amp;AccountID=s_2dc21239d6a&amp;Inflow=pocketsalad.co.kr" id="naver-common-inflow-script"></script>
...
<body id="body" class="body-member body-join-method pc"  >
        ...
        <!-- 본문 시작 -->
            ...
            <div class="location_wrap">
                <div class="location_cont">
                    <em><a href="#" class="local_home">HOME</a> > 회원가입 > 가입방법 선택</em>
                </div>
            </div>
            <!-- //location_wrap -->
            ...
            <div class="sub_content">
                ...
                <!-- //side_cont -->
<!--<a href="https://www.pocketsalad.co.kr/board/view.jsp?period=current&amp;bdId=event&amp;sno=20">
	<img style="display:block; text-align:center; width:100%; padding:0 0 30px 0;" src="https://atowertr6856.cdn-nhncommerce.com/data/editor/board/event/new_join/1200x250_02.jpg"></a>-->
...
<div class="content_box">
	<div class="member_wrap">
		...
		<div class="member_cont">
			...
			<div class="member_sns_login">
				<div class="inside">
					<h2 class="tit"></h2>
					<div class="sub-tit">
						<p class="font-big">카카오로 3초 만에 가입하고</p>
						<p class="font">첫 샐러드를 0원에!</p>
						<p class="font"> 정기배송 10,000원 할인 바로 받으세요.</p>
					</div>
					<ul>
						<li>
							<a href="#" class="btn_naver_login js_btn_kakao_login_app" data-kakao-type="join_method" data-return-url="/member/join_method.jsp"><img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/img/etc/pc_kakao_join.png" alt="카카오 아이디 회원가입">
								<span>카카오로 시작하기</span>
							</a>
						</li>
						<li>
							<a href="#" class="btn_naver_login js_btn_naver_login" data-naver-type="join_method" data-naver-url=""><img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/img/etc/pc_naver_join.png" alt="네이버 아이디 로그인">
								<span>네이버로 시작하기</span>
							</a>
						</li>
						<li>
							<a href="#" class="btn_apple_login js_btn_apple_login">
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/img/etc/pc_apple_join.png" alt="Apple 아이디 회원가입">
								<div id="appleid-signin" style="display: none"></div>
								<span id="apple_btn">Apple로 시작하기</span>
							</a>
						</li>
						<li>
							<a href="#" id="btnJoin" class="shop_mall_join" ><span>ID/PW 회원가입</span></a>
						</li>
					</ul>
				...
				<strong class="chk_none">
					<i></i>
					SNS계정으로 빠르고 쉽게 회원가입 하세요! <br />
				</strong>
			</div>


			<!--			<div class="member_login_box">-->
			<!--				<h2 class="c_tit">또는 </h2>-->
		...
		<div class="member_guide_txt">
			<p>포켓샐러드 회원이세요?<a href="#" id="btnLoginMember">로그인</a></p>
		</div>
