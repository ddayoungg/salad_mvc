...
<script type="text/javascript" src="http://salad.sist.co.kr/resources/js/naver/naverCommonInflowScript.js?Path=/member/find_id.jsp&amp;Referer=https://www.pocketsalad.co.kr:443&amp;AccountID=s_2dc21239d6a&amp;Inflow=pocketsalad.co.kr" id="naver-common-inflow-script"></script>
...
<div class="content_box">
	<div class="member_wrap">
		...
		<div class="member_cont">
			<form id="formFindpass" method="post" action="find_pass_reset.do">
				<div class="find_id_box">
					<div class="find_id_sec">
						...
						<div>
							...
							<div>
								...
								<input type="text" id="email" name="email" class="input_email" placeholder="가입메일주소" >
								<select id="emailDomain" name="emailDomain" class="email_select chosen-select">
							...
							<p class="info_again">아이디를 모르시나요? <a href='find_id.do' class="js_btn_find_id">아이디 찾기</a></p>
						</div>
					...
					<div class="btn_member_sec">
						<ul>						
							<li><button type="submit" class="btn_member_id">다음</button></li>
						</ul>
					</div>
					<!-- //btn_member_sec -->
				</div>
	...
	$(document).ready(function () {
		...
		$('input[name="findIdFl"]').on('click', function(){
		    if ($(this).val() == 'cellPhone') {
		        $('input[id="email"]').attr('style','display:none !important').prop('disabled', true);
                ...
                $('input[id="email"]').prop('disabled', false).show();
...
<%-- <script type="text/template" id="templateFindIdResult">
	<div class="find_complete_box"><p><%=name%> 회원님의 아이디는 <br><strong><%=memberId%></strong> 입니다</p></div>
</script> --%>
