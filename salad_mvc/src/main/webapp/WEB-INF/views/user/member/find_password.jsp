...
<head>
    ...
    <meta name="csrf-token" content="MTY2NjY4NzAwMDY2NzM4NTMzMTk3MzM0OTU1NTA2OTc3MjcxNzQzMDY0" />
   <meta name="facebook-domain-verification" content="l8vlpgoyq5exc97dfww64gqzmnialy" />
    ...
    <meta property="og:url" content="https://www.pocketsalad.co.kr/member/find_password.jsp">
...
<script type="text/javascript">
    ...
    <!-- Add script : start -->
    <script type="text/javascript" src="/admin/gd_share/script/visit/gd_visit.js?requestUrl=https%3A%2F%2Fcollector-statistics.nhn-commerce.com%2Fhttp.msg&requestData=%7B%22base_time%22%3A%222022-10-25T17%3A36%3A40%2B09%3A00%22%2C%22mall_id%22%3A%22652040%22%2C%22user_id%22%3Anull%2C%22refer%22%3A%22https%3A%5C%2F%5C%2Fwww.pocketsalad.co.kr%3A443%22%2C%22uri%22%3A%22find_password.jsp%22%2C%22domain%22%3A%22www.pocketsalad.co.kr%22%2C%22country%22%3A%22kr%22%2C%22solution%22%3A%22G5%22%7D&dummyData=?v=2020120404"></script>
    <!-- Add script : end -->
...
<script type="text/javascript" src="http://localhost/salad_mvc/resources/js/naver/naverCommonInflowScript.js?Path=/member/find_password.jsp&amp;Referer=https://www.pocketsalad.co.kr:443&amp;AccountID=s_2dc21239d6a&amp;Inflow=pocketsalad.co.kr" id="naver-common-inflow-script"></script>
...
<body id="body" class="body-member body-find-password pc"  >
...
<div class="content_box">
	<form name="formFind" id="formFind" action="../member/user_certification.jsp" method="post">
	...
	$(document).ready(function () {
		...
		$('#formFind').validate({
			...
			messages: {
				...
				$.post('../member/find_ps.jsp', data).done(function (data, textStatus, jqXHR) {
