...
<div class="board_write_popup">
    <div class="ly_tit"><h4>상품문의 상세정보</h4></div>
    <div class="ly_cont">
            <div class="scroll_box">
                ...
                <div class="board_write_box">
                    <table class="board_write_table">
                        ...
                        <tr>
                            <th scope="row">작성자/날짜</th>
                            <td>
                            	 <c:out value="${fn:substring(qnaData.name,0,1) }"/>
							      <!-- 5자리부터 id의 길이만큼 *를 찍어줌 -->
							      <c:forEach begin="1" end="${fn:length(qnaData.name)-1}" step="1">
							        *
							      </c:forEach>
                                |
                                <c:out value="${ qnaData.qnaWriteDate }"/>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Q. 제목</th>
                            <td>
                        ...
                        <c:choose>
                        	<c:when test="${ qnaData.qnaAFlag eq '0' }">
                        		<tr>
		                            <th scope="row" style="align-content: center" colspan="2">
		                            <!-- 미답변 -->
		                            	<small>아직 </small><c:out value="[미답변]"/><small>입니다. 답변이 작성될 때까지 기달려주세요.</small>
		                            </th>
		                            <td></td>
		                        </tr>
                        	</c:when>
                        	<c:when test="${ qnaData.qnaAFlag eq '1' }">
	                        	<tr>
		                            <th scope="row">답글 작성일</th>
		                            <td class="wirte_editor">
		                            	<c:out value="${ qnaData.qnaAWriteDate }"/>
		                            </td>
		                        </tr>
		                        <tr>
        ...
        <div class="btn_center_box">
            <a href="#void" id="closeBtn"><button class="btn_ly_write_ok"><strong>확인</strong></button></a>
        </div>
    </div>
    <!-- //ly_cont -->
</div>
