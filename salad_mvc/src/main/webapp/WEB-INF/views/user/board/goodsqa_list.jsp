...
<head>
    ...
    <meta name="csrf-token" content="MTY2Njg2MzEyMzExNzQxNjYzOTQ5NTE3MDU1OTA0NDI5NDc4MTE0Njgw" />
   <meta name="facebook-domain-verification" content="l8vlpgoyq5exc97dfww64gqzmnialy" />
    ...
    <meta property="og:url" content="https://www.pocketsalad.co.kr/board/list.jsp?bdId=goodsqa">
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1578 ,'n')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1576 ,'n')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1575 ,'c')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1574 ,'n')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1573 ,'n')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1572 ,'n')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1571 ,'n')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
					...
					<tr style="height:50px">
						...
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1570 ,'n')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1567 ,'n')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1566 ,'c')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1565 ,'c')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1563 ,'c')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1562 ,'n')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1561 ,'c')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
...
[상품 문의]						</td>
						<td class="board_tit">
							...
							<a href="javascript:gd_btn_view('goodsqa',1560 ,'n')" >
								<img src="https://atowertr6856.cdn-nhncommerce.com/data/skin/front/kaimen_pc_n/board/skin/qa/img/icon/icon_board_secret.png" align=absmiddle>
								<strong>문의드립니다♥</strong>
							</a>
						</td>
			...
			<!-- //board_list_qa -->
			<div class="pagination"><ul><li class="on"><span>1</span></li><li><a href="./list.jsp?page=2&amp;bdId=goodsqa">2</a></li><li><a href="./list.jsp?page=3&amp;bdId=goodsqa">3</a></li><li><a href="./list.jsp?page=4&amp;bdId=goodsqa">4</a></li><li><a href="./list.jsp?page=5&amp;bdId=goodsqa">5</a></li><li><a href="./list.jsp?page=6&amp;bdId=goodsqa">6</a></li><li><a href="./list.jsp?page=7&amp;bdId=goodsqa">7</a></li><li><a href="./list.jsp?page=8&amp;bdId=goodsqa">8</a></li><li><a href="./list.jsp?page=9&amp;bdId=goodsqa">9</a></li><li><a href="./list.jsp?page=10&amp;bdId=goodsqa">10</a></li><li class="btn_page btn_page_next"><a aria-label="Next" href="./list.jsp?page=11&amp;bdId=goodsqa"><img src=/admin/gd_share/img/icon_arrow_page_r.png class=img-page-arrow>다음</a></li><li class="btn_page btn_page_last"><a aria-label="Last" href="./list.jsp?page=99&amp;bdId=goodsqa"><img src=/admin/gd_share/img/icon_arrow_page_rr.png class=img-page-arrow>맨뒤</a></li></ul></div>
			<!-- //pagination -->
		</div>
		<!-- //board_zone_list -->

		<div class="btn_right_box">
			<button type="button" class="btn_write" onclick="gd_btn_write('goodsqa')"><strong>1:1 문의하기</strong></button>
		</div>
