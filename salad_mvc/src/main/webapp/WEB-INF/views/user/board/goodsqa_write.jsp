...
<head>
    ...
    <meta name="csrf-token" content="MTY2NjgwMzYxNjAzOTc5MjEwMzMyNzI0NTI1NDY3NjUwODQyNDE5MTYw" />
    ...
    <meta property="og:url" content="https://www.pocketsalad.co.kr/board/write.jsp?noheader=y&amp;memNo=85754&amp;mypageFl=y&amp;bdId=goodsqa">
...
<div class="board_zone_sec">
	...
	<div class="board_zone_cont">
		<form name="frmWrite" id="frmWrite" action="./board_ps.jsp" method="post" enctype="multipart/form-data" class="frmWrite">
			...
			<input type="hidden" name="returnUrl" value="noheader=y&memNo=85754&mypageFl=y&bdId=goodsqa">
						...
						<tr>
							...
							<td>
								<div class="category_select"  style="width:312px;">
									<select class=" tune" id="category" name="category" style="width:127px;"><option value="">문의 내용을 선택해 주세요.</option><option value="상품 문의"  >상품 문의</option></select>
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<div class="board_goods_select">
									...
									<a href="#addGoodsLayer" title="찾아보기" class="btn_goods_select btn_open_layer"> 상품 선택 </a>
