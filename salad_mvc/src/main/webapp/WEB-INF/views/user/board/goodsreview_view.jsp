...
<head>
    ...
    <meta name="csrf-token" content="MTY2Njg2MTg4MjIwNTE5ODY3Mjk4MTkyODY0Mzg4MzYzNDEwOTc4MDk1" />
   <meta name="facebook-domain-verification" content="l8vlpgoyq5exc97dfww64gqzmnialy" />
    ...
    <meta property="og:url" content="https://www.pocketsalad.co.kr/board/view.jsp?&amp;bdId=goodsreview&amp;sno=17846">
...
<script type="text/javascript" src="http://salad.sist.co.kr/resources/js/naver/naverCommonInflowScript.js?Path=/board/view.jsp&amp;Referer=https://www.pocketsalad.co.kr:443&amp;AccountID=s_2dc21239d6a&amp;Inflow=pocketsalad.co.kr" id="naver-common-inflow-script"></script>
...
<body id="body" class="body-board body-view pc"  >
                ...
                <div class="view_goods_select">
                    <div class="view_goods_select_item">
                        <span class="view_select_item_img">
                                <img src="http://salad.sist.co.kr/common/images/product/${thum}">
                        </span>
                    ...
                    <c:if test="${ revImgList ne null }"> 
                    	<c:forEach var="revImg" items="${ revImgList }">   
                        	<span class="view_select_item_img" style="margin:10px 30px 10px 0">
                        		<img src="http://salad.sist.co.kr/common/images/review/${revImg}" width=200px height=200px >
                        	</span>
                        </c:forEach>
                    </c:if>
...
<!-- //layer_wrap -->
<script type="text/javascript" src="http://salad.sist.co.kr/resources/js/gd_board_view.js" charset="utf-8"></script>
</div>
<!-- //content -->
            </div>
            <!-- //sub_content -->
