...
<script type="text/javascript" src="http://localhost/salad_mvc/resources/js/naver/naverCommonInflowScript.js?Path=/board/view.jsp&amp;Referer=https://www.pocketsalad.co.kr:443&amp;AccountID=s_2dc21239d6a&amp;Inflow=pocketsalad.co.kr" id="naver-common-inflow-script"></script>
                ...
                <div class="view_goods_select">
                    <div class="view_goods_select_item">
                        <span class="view_select_item_img">
                                <img src="http://localhost/salad_mvc/common/images/product/${thum}">
                        </span>
                    ...
                    <c:if test="${ revImgList ne null }"> 
                    	<c:forEach var="revImg" items="${ revImgList }">   
                        	<span class="view_select_item_img" style="margin:10px 30px 10px 0">
                        		<img src="http://localhost/salad_mvc/common/images/review/${revImg}" width=200px height=200px >
                        	</span>
                        </c:forEach>
                    </c:if>
