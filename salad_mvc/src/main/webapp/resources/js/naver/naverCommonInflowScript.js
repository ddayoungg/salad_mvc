    ...
    if (NCISP.Path === "/goods/goods_view.php") {
        ...
        if (parseFloat(naverMileageBaseAccumRate) > 0) {
            ...
            if (parseFloat(naverMileageAddAccumRate) > 0) {
                if (document.getElementById("naver-mileage-add-accum-rate")) document.getElementById("naver-mileage-add-accum-rate").innerHTML = "&nbsp;+&nbsp;異붽�&nbsp;" + naverMileageAddAccumRate.replace(/\.0$/, "") + "%";
            }
        }
        // 2013-09-02, �ㅼ씠踰껹N �⑥튂
