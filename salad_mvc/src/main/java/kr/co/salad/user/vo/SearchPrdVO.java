...
public class SearchPrdVO {
	...
	public SearchPrdVO(int startNum, int endNum, int currentPage, int prdNum, int mainCateNum, int subCateNum,
	...
	public String toString() {
		return "SearchPrdVO [startNum=" + startNum + ", endNum=" + endNum + ", currentPage=" + currentPage + ", prdNum="
				+ prdNum + ", mainCateNum=" + mainCateNum + ", subCateNum=" + subCateNum + ", sortType=" + sortType
				+ ", keyword=" + keyword + "]";
	}
